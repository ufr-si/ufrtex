...
Aqui serão dadas indicações gerais para a apresentação gráfica de seu trabalho, contudo, você pode consultar a \sigla{NBR} 14724:2011 para obter mais informações sobre a apresentação de trabalhos acadêmicos da \sigla{UFRON}.
